            ...
            <div class="row">
                ...
                <a href="#" data-backup class="m-1" title="Desacer cambios realizados (Z)">
                    ...
                    <a href="#" data-function class="m-1" title="Añadir elemento (I)">
                        <span id="Add" data-options='[["m","viewAddCategoria"]]' class="badge bg-success">Agregar Nueva Categoria</span>
                    </a>
                </div>
            </div>
        </div>
                                                ...
                                                <th>
                                                    <div class="dropdown">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" class="btn btn-danger ms-1"
                                                                                    ...
                                                                                    <a class="dropdown-item" href="#" data-function
                                                                                        data-options='[["m","delCategoria"],["id","<?php echo $v['id']; ?>"]]'><i
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" onclick="modal(<?php echo $v['id'] ?>)"><i class="bi bi-trash3-fill text-danger m-1"></i>Eliminar</a>
                                                        </div>
                                                    </div>
                                                </th>
                                            </tr>
